...
//   層 3  state-verbs-ledger.ts / state-verbs-queue.ts … 50 verb の cmd 実装
...
// LEDGER_VERBS (帳簿 17) で尽きる。どちらにも属さない verb を足すと state.test.ts の
// 分類ネットが落ちる。
// ---------------------------------------------------------------------------
